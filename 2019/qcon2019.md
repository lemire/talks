...
# <!--fit--> Trick #1 : Use SIMD instructions
...
## <!--fit--> Trick #2 : avoids hard-to-predict branches
...
## <!--fit--> Trick #3 : avoids memory/object allocation

---

# <!--fit--> In simdjson, the DOM (document-object-model) is stored into one contiguous tape.
...
# <!--fit-->  From there, we can find where the string content is,
# <!--fit-->  using three more instructions.
...
## # <!--fit--> Example 4. Number parsing is expensive
